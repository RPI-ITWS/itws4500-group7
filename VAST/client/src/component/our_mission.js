    ...
    return (
        <div>
            ...
            <p id="mainContent">At VAST, we want to not only provide relevant scientific data, but also strive to
                ...
                along with interactive, pre-built data visualizations, which can create discussions with students.
            ...
            <div className="container">
                <div className="row">
                    <div className="card" style={{ width: "70rem", padding: "0" }}>
                        <div className="card-header">
                            What is Global Warming?
                        </div>
                        <div className="card-body-mission">
                            <blockquote className="blockquote mb-0">
                                <p style={{ padding: "8px" }}>Within today's society, most individuals, both adults and children alike, have heard of
                                    global warming. But what is it actually? Global warming can be described as <strong>a
                                        ...
                                        greenhouse gases.</strong> In fact, Scientists agree that the overall surface temperature
                                    of the Earth has
                ...
                <div className="row">
                    <div className="card" style={{ width: "70rem", padding: "0" }}>
                        ...
                        <div className="card-body-mission">
                            <blockquote className="blockquote mb-0">
                                <p style={{ padding: "8px" }}> In addition to the significant increase to our surface temperature, global warming
                                    still has many far-reaching effects on the Earth that significantly impacts the environment.
                                    ...
                                    become increasingly severe, with more intense heat waves, hurricanes, and floods, just to
                                    name a few.
                                    And because the increase in temperature is causing our glaciers to melt, our sea levels are
                                    currently rising
                ...
                <div className="row">
                    <div className="card" style={{ width: "70rem", padding: "0" }}>
                        ...
                        <div className="card-body-mission">
                            <blockquote className="blockquote mb-0">
                                <p style={{ padding: "8px" }}> Because of the drastic effect that Global Warming has on our Earth, it therefore also
                                    effects the lifeforms and
                                    the ecosystems that our planet provides. Warmer temperature means that migrating animals
                                    start seeking food sources earlier,
                                    and the shift in seasons may already be causing the lifecycle of pollinators, like bees, to
                                    be out of synch with flowering plants and trees.
                                    Additionally, a change in temperature also leads to an extension of growing seasons; this
                                    ...
                                    some cases, the temperature has become
                                    too extreme for certain species of animals to survive, causing them to migrate towards the
                                    poles. However, because they cannot adapt to the
                ...
                <div className="row">
                    <div className="card" style={{ width: "70rem", padding: "0" }}>
                        ...
                        <div className="card-body-mission">
                            <blockquote className="blockquote mb-0">
                                <p style={{ padding: "8px" }}> We as human beings also exist within the ecosystems that Earth provides, which means that
                                    Global Warming directly impacts us as well. As the
                                    zone of tropical temperature expands, the spread and reach of infectious diseases, such as
                                    malaria, will also grow. More intense weather conditions,
                                    such as rains, hurricanes, and rising sea levels will cause more severe flooding and
                                    increased potential for loss of life and property damage.
                                    Additionally, more frequent fires and hotter summer temperature cause an increased risk of
                                    heat strokes and death, and if intense droughts occur,
                                    malnutrition is a possibility to those living in significantly affected areas.
                                </p>
                                <footer className="blockquote-footer"><cite title="Source Title">Resources:
                                </cite>https://earthobservatory.nasa.gov/features/GlobalWarming/page6.php</footer>
                            </blockquote>
