...
const Timer = ({ sec }) => {
    ...
    const tick = () => {
        if (seconds > 0 && active) {
            ...
            const actual_red = parseInt(color.substr(0, 2), 16);
            const actual_green = parseInt(color.substr(2, 4), 16);
            const actual_blue = parseInt(color.substr(4, 6), 16);
            const guessed_red = parseInt(guessColor.substr(0, 2), 16);
            const guessed_green = parseInt(guessColor.substr(2, 4), 16);
            const guessed_blue = parseInt(guessColor.substr(4, 6), 16);
            ...
            <center>
                <div className="counter">
                    ...
                    >
                        ...
                        <button class="my-button" //id="button_style"
                            onClick={() => {
                                generateColor();
                                resetTimer();
                            }
